...
Staff resource for DOD contractor.  
  ...
  - Built web-based search engine for engineering database 
  - Wrote file management application for CAD files using X/MOTIF
  - Enhancement of CGI-based application for departmental intranet
...
Developer working on home-grown inventory management system for an office product(s) wholesaler.
  ...
  - Report writing on PROGRESS 4GL relation database
  - Integrated inbound EDI 850s with WINS order entry system
  - Built custom pricing module for wholesale price list management
